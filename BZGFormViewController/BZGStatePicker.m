...
+ (NSArray *)stateCodes
{
    ...
    if (!_stateCodes)
    {
        _stateCodes = [[NSArray alloc] initWithObjects:@"XX", @"AL", @"AK", @"AZ", @"AR", @"AS", @"CA", @"CO", @"CT", @"DE", @"FL", @"GA", @"GU", @"HI", @"ID", @"IL", @"IN", @"IA", @"KS", @"KY", @"LA", @"ME", @"MD", @"MA", @"MI", @"MN", @"MS", @"MO", @"MT", @"NE", @"NV", @"NH", @"NJ", @"NM", @"NY", @"NC", @"ND", @"MP", @"OH", @"OK", @"OR", @"PA", @"PR", @"RI", @"SC", @"SD", @"TN", @"TX", @"UT", @"VT", @"VA", @"VI", @"WA", @"DC", @"WV", @"WI", @"WY", nil];
    }
    return _stateCodes;
}
